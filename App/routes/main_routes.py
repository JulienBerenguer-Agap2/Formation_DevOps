...
[\w\.-]+ : Correspond à un ou plusieurs caractères alphanumériques, tirets (-), points (.) ou underscores (_).
...
\w+ : Correspond à un ou plusieurs caractères alphanumériques pour le domaine.
